    ...
    return (
        <HeaderWrapper>
            <div className="top">
                ...
                <div className="t-center" style={{ display: isPathPartlyExisted(pathname) ? "none" : "block" }}>
                    <span className='t-txt'>{title}</span>
                </div>
                <div className="t-notice" style={{ display: isPathPartlyExisted(pathname) ? "none" : "block" }}>
